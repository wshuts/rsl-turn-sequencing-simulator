...
EXPECTED_56_87: list[ParsedRow] = [
    ParsedRow(56, 21, "UP",     "Mikage",      "A_A1", 20, "UP"),
    ParsedRow(57, 20, "UP",     "Mithrala",    "A1",   18, "UP"),
    ParsedRow(58, 18, "UP",     "Tomb Lord",   "A2",   17, "UP"),
    ParsedRow(59, 17, "UP",     "Coldheart",   "A1",   12, "UP"),
    ParsedRow(60, 12, "UP",     "Martyr",      "A2",   12, "UP"),
    ParsedRow(61, 21, "UP",     "Fire Knight", "A2",    5, "UP"),
    ...
    ParsedRow(69, 21, "UP",     "Fire Knight", "A1",   11, "UP"),
    ...
    ParsedRow(75, 21, "UP",     "Fire Knight", "A1",   10, "UP"),
    ParsedRow(76, 10, "UP",     "Mithrala",    "A1",    8, "UP"),
    ParsedRow(77,  8, "UP",     "Tomb Lord",   "A1",    5, "UP"),
    ParsedRow(78,  5, "UP",     "Mikage",      "B_A1",  4, "UP"),
    ParsedRow(79,  4, "UP",     "Coldheart",   "A1",    0, "BROKEN"),
    ParsedRow(80,  0, "BROKEN", "Martyr",      "A2",    0, "BROKEN"),
    ParsedRow(81, 21, "UP",     "Fire Knight", "A1",    5, "UP"),
